      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          <p className="text-sm font-bold text-gray-400">
            No posts found from your children.
          </p>
        </div>
      ) : (
        <div className="space-y-4">
          {posts.map((post) => (
            <div
              key={post.id}
              className="flex gap-3 md:gap-4 p-3 rounded-2xl hover:bg-gray-50 transition-colors cursor-pointer group"
            >
              {post.media_url && (
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-start gap-2">
                  <div className="min-w-0">
                    <span className="text-[10px] font-black uppercase tracking-wider text-brand-purple bg-brand-purple/10 px-2 py-0.5 rounded-full inline-block mb-1">
                  ...
                  <span className="text-xs font-bold text-gray-400 whitespace-nowrap flex-shrink-0 pt-1">
