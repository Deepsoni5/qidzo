...
export default function SignInForm() {
  ...
  const [mode, setMode] = useState<"login" | "reset_request" | "reset_verify">(
    "login",
  );
  ...
  const onSubmit = async (data: Values) => {
    ...
    try {
      ...
      const errorMsg =
        errors.length > 0 ? errors[0].message : "Invalid credentials";
      ...
      if (errorCode === "form_identifier_not_found") {
        ...
        userMsg =
          "This email is already registered with a password. Please use your email and password below.";
      } else if (errorCode === "strategy_for_user_invalid") {
        userMsg =
          "Social login detected! Please use Google or Facebook to sign in.";
      } else if (errorMsg) {
        userMsg = errorMsg;
      }
      ...
      <div className="p-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-nunito font-black text-gray-800 mb-2">
            Login Here
            <span className="inline-block ml-2 text-brand-purple">🔐</span>
          </h2>
        ...
        {mode === "reset_verify" && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500 font-bold">
              ...
              <span className="font-black">{resetEmail}</span>
            </p>
