...
export default function MessagesPage() {
      ...
      try {
        ...
        if (initialChannelFromQuery) {
          ...
          if (dmRes.ok) {
            ...
            if (
              dmRes.status === 403 &&
              (data as any)?.code === "CHAT_LIMIT_REACHED"
            ) {
  ...
  function ConversationHeader() {
    ...
    const usernamesMap =
      ((channel?.data as any)?.usernames as
    ...
    return (
      <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between bg-white">
        ...
        <div className="flex items-center gap-2">
          {/* Call Buttons - Only show when we have other user ID */}
          {otherId && <CallButtons otherUserId={otherId} />}
  ...
  function TypingIndicatorBar() {
    ...
    const typingUsers = (Object.values(typing || {}) as any[]).filter(
      (t: any) => {
    ...
    const name =
      (otherUser.name as string) || (otherUser.id as string) || "Someone";
