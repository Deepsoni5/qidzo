    ...
    try {
      ...
      if (result.success) {
        toast.success("You're in! 🎉", {
          description:
            "Be kind, stay safe, and share only kid‑friendly content. No adult content. Your activity is monitored for safety.",
          style: {
        ...
        <div className="p-6 bg-white rounded-b-[32px]">
          <form action={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <label className="text-gray-400 font-bold ml-2 text-xs uppercase tracking-wider">
                Username
              </label>
              ...
              <div className="w-full flex flex-col sm:flex-row gap-3">
                <Link href="/sign-in" className="w-full">
                  <button className="w-full py-3 px-4 border-2 border-dashed border-gray-200 rounded-xl text-gray-500 hover:text-brand-purple hover:border-brand-purple hover:bg-purple-50 font-bold text-sm transition-all flex items-center justify-center gap-2 cursor-pointer">
                    ...
                    Parents / Ambassador Login
                  </button>
                </Link>
                <Link href="/school/sign-in" className="w-full">
                  <button className="w-full py-3 px-4 border-2 border-dashed border-gray-200 rounded-xl text-gray-500 hover:text-brand-purple hover:border-brand-purple hover:bg-purple-50 font-bold text-sm transition-all flex items-center justify-center gap-2 cursor-pointer">
                    <School className="w-4 h-4" />
                    NGO / School / College Login
                  </button>
                </Link>
              </div>
            </div>
